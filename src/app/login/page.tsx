...
const errorMessages: Record<string, string> = {
  ...
  missing_code: "The sign-in request didn’t include a valid code. Please try again.",
    ...
    <main className="marketing-shell">
      ...
      <section className="hero-grid">
        <div className="hero-copy">
          ...
          <div className="trust-row"><span>✓ Google or email</span><span>✓ Your data, your control</span><span>✓ Free account</span></div>
        </div>

        <section className="product-preview stack" aria-label="Sign in to LandingNL">
          <span className="pill">FREE ACCOUNT</span>
          <h2 style={{ marginBottom: 0 }}>Save your LandingNL plan</h2>
          <p>Choose Google or use any email address. No password is required.</p>
          <GoogleSignInButton />
          <div className="auth-divider"><span>OR</span></div>
          <EmailSignInForm />
          {error ? <div className="card" role="alert" style={{ color: "#8f2334" }}>{error}</div> : null}
          <div className="preview-steps">
            <div className="preview-step"><span>1</span><div><strong>Sign in</strong><small>Continue securely with Google or email</small></div></div>
